    ...
    prompts: [
      {
        ...
        prompt:
          "What should I focus on next in my job search? Review my pipeline and suggest the best next action.",
      },
      {
        label: "Which job should I prioritize?",
        prompt:
          "Looking at my pipeline, which job should I prioritize and why?",
      },
      {
        label: "Why is nothing ready?",
        prompt:
          "Why aren't any of my jobs in the Ready to Apply queue? What's blocking me?",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Can you review my evidence library and suggest how I could strengthen my resume?",
      },
      {
        label: "Review flagged claims",
        prompt:
          "Are there any claims in my application materials that need stronger evidence backing?",
      },
      {
        label: "Help me tailor this package",
        prompt:
          "Help me tailor my application package to better match a specific job's requirements.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        label: "Build my evidence",
        prompt:
          "Help me add to my evidence library. Ask me about my achievements and experiences.",
      },
      {
        label: "What proof am I missing?",
        prompt:
          "What types of evidence or achievements am I missing that could strengthen my applications?",
      },
      {
    ...
    prompts: [
      {
        ...
        prompt:
          "I have an upcoming interview. Can you help me prepare with targeted tips?",
      },
      {
        label: "Draft a recruiter follow up",
        prompt:
          "Help me draft a professional follow-up message to a recruiter.",
      },
      {
        label: "What to say after applying",
        prompt:
          "I just applied for a job. What should I do next and what should I say if I follow up?",
      },
    ],
  },
];
    ...
    <div className={cn("flex flex-col h-full bg-background", className)}>
      ...
      <div className="shrink-0 border-t border-border/70 bg-background px-4 py-3.5">
        ...
        <p className="text-[10px] text-muted-foreground/60 mt-2 text-center">
          Grounded in your verified evidence — Enter to send, Shift+Enter for
          new line
        </p>
      </div>
    </div>
