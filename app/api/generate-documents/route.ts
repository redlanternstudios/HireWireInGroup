    ...
    void supabase
      ...
      .update({
        resume_provenance: bulletProvenance.map((b) => ({
          ...
          source_role: b.source_role,
          source_company: b.source_company,
          matched_requirement_id: b.matched_requirement_id,
          matched_requirement_text: b.matched_requirement_text,
          match_strength: b.match_strength,
          match_reason: b.match_reason,
          evidence_strength: b.evidence_strength,
          proof_decision: b.proof_decision,
          proof_snippets: b.proof_snippets,
          why_included: b.why_included,
          claim_confidence: b.claim_confidence,
          keywords_covered: b.keywords_covered,
