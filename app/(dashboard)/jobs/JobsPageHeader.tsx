    ...
    <div className="flex items-center justify-between mb-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1 max-w-2xl">
          Track every opportunity from first scan to final application. Use this page to analyze job links, score your fit, generate materials, review quality, and move strong roles into Ready to Apply.
        </p>
      </div>
      <div className="flex gap-2">
        ...
        <a href="/ready-to-apply" className="rounded-lg border border-border px-4 py-2 font-medium text-foreground hover:bg-muted transition-colors">View Ready to Apply</a>
      </div>
    </div>
  )
}
