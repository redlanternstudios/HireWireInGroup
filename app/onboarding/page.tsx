  ...
  const handleResumeUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!data.inserted || data.inserted === 0) {
        toast.warning("Resume saved, but no evidence items were extracted. You can add evidence manually later.")
      } else {
      ...
      <div className="min-h-screen flex items-center justify-center p-6 bg-background">
        <Card className="w-full max-w-lg border-0 shadow-none lg:border lg:shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-semibold">Import Your Resume</CardTitle>
            <CardDescription>
      ...
      <div className="min-h-screen flex items-center justify-center p-6 bg-background">
        <Card className="w-full max-w-xl border-0 shadow-none lg:border lg:shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {hasResume
                ? "We pre-filled your details from your resume. Make any changes below."
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background">
      <Card className="w-full max-w-lg border-0 shadow-none lg:border lg:shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Your profile is ready. Let&apos;s analyze a job and see how HireWire works.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
