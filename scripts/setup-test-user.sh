...
node --env-file-if-exists=/vercel/share/.env.project <<'JSEOF'
...
async function setupTestUser() {
  try {
    ...
    console.log(profileError ? '⚠️ Profile warning' : '✅ Profile created');
    ...
    console.log(userError ? '⚠️ Users warning' : '✅ Users table configured');
