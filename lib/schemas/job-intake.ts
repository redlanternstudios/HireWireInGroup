...
export const AnalyzeJobInputSchema = z
  .object({
    job_url: z
      .string()
  ...
  .refine((data) => data.job_url || data.job_description, {
...
export type GenerateDocumentsInput = z.infer<
  typeof GenerateDocumentsInputSchema
>;
...
export type GenerateInterviewPrepInput = z.infer<
  typeof GenerateInterviewPrepInputSchema
>;
